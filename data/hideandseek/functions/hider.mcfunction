...
execute if entity @a[team=seekers,distance=..10] run function hideandseek:heartbeat

#> Camouflage
# 0 = not, 1 = in progress, 2 = done, 3 = uncamouflage
execute if score @s sneaking_timer matches 50 if score @s camouflaged matches 0 unless score game_length hs_timers matches 0 at @s as @s run function hideandseek:camouflage
...
execute unless score @s camo_cooldown matches 15 if score @s camoflauged matches 2 if score @s playerID matches 10 run teleport @e[type=falling_block,tag=hideandseek,scores={playerID=10},limit=1]
execute unless score @s camo_cooldown matches 15 if score @s camoflauged matches 2 if score @s playerID matches 11 run teleport @e[type=falling_block,tag=hideandseek,scores={playerID=11},limit=1]
execute unless score @s camo_cooldown matches 15 if score @s camoflauged matches 2 if score @s playerID matches 12 run teleport @e[type=falling_block,tag=hideandseek,scores={playerID=12},limit=1]
execute unless score @s camo_cooldown matches 15 if score @s camoflauged matches 2 if score @s playerID matches 13 run teleport @e[type=falling_block,tag=hideandseek,scores={playerID=13},limit=1]
execute unless score @s camo_cooldown matches 15 if score @s camoflauged matches 2 if score @s playerID matches 14 run teleport @e[type=falling_block,tag=hideandseek,scores={playerID=14},limit=1]
execute unless score @s camo_cooldown matches 15 if score @s camoflauged matches 2 if score @s playerID matches 15 run teleport @e[type=falling_block,tag=hideandseek,scores={playerID=15},limit=1]
execute unless score @s camo_cooldown matches 15 if score @s camoflauged matches 2 if score @s playerID matches 16 run teleport @e[type=falling_block,tag=hideandseek,scores={playerID=16},limit=1]
execute unless score @s camo_cooldown matches 15 if score @s camoflauged matches 2 if score @s playerID matches 17 run teleport @e[type=falling_block,tag=hideandseek,scores={playerID=17},limit=1]
execute unless score @s camo_cooldown matches 15 if score @s camoflauged matches 2 if score @s playerID matches 18 run teleport @e[type=falling_block,tag=hideandseek,scores={playerID=18},limit=1]
execute unless score @s camo_cooldown matches 15 if score @s camoflauged matches 2 if score @s playerID matches 19 run teleport @e[type=falling_block,tag=hideandseek,scores={playerID=19},limit=1]
execute unless score @s camo_cooldown matches 15 if score @s camoflauged matches 2 if score @s playerID matches 20 run teleport @e[type=falling_block,tag=hideandseek,scores={playerID=20},limit=1]
execute unless score @s camo_cooldown matches 15 if score @s camoflauged matches 2 if score @s playerID matches 21 run teleport @e[type=falling_block,tag=hideandseek,scores={playerID=21},limit=1]
execute unless score @s camo_cooldown matches 15 if score @s camoflauged matches 2 if score @s playerID matches 22 run teleport @e[type=falling_block,tag=hideandseek,scores={playerID=22},limit=1]
execute unless score @s camo_cooldown matches 15 if score @s camoflauged matches 2 if score @s playerID matches 23 run teleport @e[type=falling_block,tag=hideandseek,scores={playerID=23},limit=1]
...
execute if score @s camouflaged matches 3 run function hideandseek:uncamouflage

## Death
execute if score @s dead matches 1 run function hideandseek:dead