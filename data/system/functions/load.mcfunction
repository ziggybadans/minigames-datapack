...
tellraw @a {"text":"To install this datapack, type /function ziggy:install","italic":true,"color":"gray","clickEvent":{"action":"suggest_command","value":"/function ziggy:install"},"hoverEvent":{"action":"show_text","contents":["Run command..."]}}